/*
 * The photographs on the signed-out page. They stand in for the angler's own, which
 * is what the app itself shows once there is a log to look at.
 */
export const photos = {
   ...
   rodReel: '/photos/gear-rod-reel.jpg',
} as const;
